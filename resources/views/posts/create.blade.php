                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <h3 class="col-4 mb-0">Write A Article</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form role="form" method="POST" action="/post/store" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group{{ $errors->has('picture') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    <input class="form-control{{ $errors->has('picture') ? ' is-invalid' : '' }}" placeholder="{{ __('Picture') }}" type="file" name="picture" value="{{ old('picture') }}" required autofocus>
                                </div>
